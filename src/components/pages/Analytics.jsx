          ...
          <div className="col-lg-4">
            <div className="card-body px-xl-9 py-12 d-flex align-items-center flex-column">
              ...
              <div className="d-flex gap-11 justify-content-between">
                ...
                <div className="d-flex">
                  <div className="avatar me-2">
                    <span className="avatar-initial rounded-2 bg-label-info"><i className="icon-base bx bx-wallet icon-lg text-info"></i></span>
                  </div>
                  <div className="d-flex flex-column">
                    <small>
                      <script>
          ...
          <ul className="p-0 m-0">
            <li className="d-flex align-items-center mb-5">
              <div className="avatar flex-shrink-0 me-3">
                <span className="avatar-initial rounded bg-label-primary"><i className="icon-base bx bx-mobile-alt"></i></span>
              </div>
            ...
            <li className="d-flex align-items-center mb-5">
              <div className="avatar flex-shrink-0 me-3">
                <span className="avatar-initial rounded bg-label-success"><i className="icon-base bx bx-closet"></i></span>
              </div>
              <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div className="me-2">
            ...
            <li className="d-flex align-items-center mb-5">
              <div className="avatar flex-shrink-0 me-3">
                <span className="avatar-initial rounded bg-label-info"><i className="icon-base bx bx-home-alt"></i></span>
              </div>
              <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div className="me-2">
            ...
            <li className="d-flex align-items-center">
              <div className="avatar flex-shrink-0 me-3">
                <span className="avatar-initial rounded bg-label-secondary"><i className="icon-base bx bx-football"></i></span>
              </div>
              <div className="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                <div className="me-2">
    ...
    <div className="col-md-12 col-lg-6 order-4 order-lg-3">
      <div className="card h-100">
        <div className="card-header d-flex justify-content-between">
          ...
          <div className="dropdown">
            <button className="btn text-body-secondary p-0" type="button" id="timelineWapper" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i className="icon-base bx bx-dots-vertical-rounded icon-lg"></i>
            </button>
      ...
      <div className="card text-center h-100">
        <div className="card-header nav-align-top">
          <ul className="nav nav-pills flex-wrap row-gap-2" role="tablist">
            ...
            <li className="nav-item">
              <button type="button" className="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-os" aria-controls="navs-pills-os" aria-selected="false">Operating System</button>
            </li>
            <li className="nav-item">
              ...
              <table className="table table-borderless">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        <img src="../../assets/img/icons/brands/safari.png" alt="Safari" height="24" className="me-3" />
...
></div>                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        <img src="../../assets/img/icons/brands/firefox.png" alt="Firefox" height="24" className="me-3" />
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px;"}}>
                          <div className="progress-bar bg-info" role="progressbar" style={{width: "8.37%"}} aria-valuenow={8.37} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        <img src="../../assets/img/icons/brands/edge.png" alt="Edge" height="24" className="me-3" />
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-warning" role="progressbar" style={{width: "6.12%"}} aria-valuenow={6.12} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        <img src="../../assets/img/icons/brands/opera.png" alt="Opera" height="24" className="me-3" />
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width: "2.12%"}} aria-valuenow={1.94} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        <img src="../../assets/img/icons/brands/uc.png" alt="uc" height="24" className="me-3" />
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width: "20.14%"}} aria-valuenow={1.94} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-success" role="progressbar" style={{width: "61.50%"}} aria-valuenow={61.50} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-primary" role="progressbar" style={{width: "16.67%"}} aria-valuenow={16.67} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-info" role="progressbar" style={{width: "12.82%"}} aria-valuenow={12.82} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-warning" role="progressbar" style={{width: "6.25%"}} aria-valuenow={6.25} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width: "2.76%"}} aria-valuenow={2.76} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width: "20.14%"}} aria-valuenow={2.76} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                        <small className="fw-medium">20.14%</small>
                      </div>
                    </td>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-success" role="progressbar" style={{width: "38.12%"}} aria-valuenow={38.12} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-primary" role="progressbar" style={{width: "28.23%"}} aria-valuenow={28.23} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-info" role="progressbar" style={{width: "14.82%"}} aria-valuenow={14.82} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-warning" role="progressbar" style={{width: "12.72%"}} aria-valuenow={12.72} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width: "7.11%"}} aria-valuenow={7.11} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex justify-content-between align-items-center gap-4">
                        <div className="progress w-100" style={{height:"10px"}}>
                          <div className="progress-bar bg-danger" role="progressbar" style={{width: "15.13%"}} aria-valuenow={7.11} aria-valuemin={0} aria-valuemax={100}></div>
                        </div>
